...
- [0054-rtfm-reward-gap](experiments/0054-rtfm-reward-gap.md) — reward-gap probe: re-run the working ~0.10 baseline (folded VR 0.3) WITH the rew head saved, then measure the imagined-vs-real reward gap. Decides the downstream fork: reward head OVER-optimistic (→ conservatism, exp0047) vs FAITHFUL (→ pure credit-assignment/execution, exp0043, needs planning/horizon). PRE-REGISTERED + IN FLIGHT (draft)
