...
- [0056-rtfm-coverage-sweep](experiments/0056-rtfm-coverage-sweep.md) — coverage sweep (--n-train-seeds ∈ {100,400,1600}) to test the depth-2 composition wall: does more DISTINCT recipes lift step-2 (combinatorial-coverage-bound) or stay flat (architectural-composition-bound)? Watches swap_follow_s1 vs exact. IN FLIGHT (draft)
