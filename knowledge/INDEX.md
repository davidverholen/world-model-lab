...
- [0055-rtfm-ensemble-pessimism](experiments/0055-rtfm-ensemble-pessimism.md) — ensemble-uncertainty (MOPO) pessimism: K=5 bootstrapped reward heads, actor optimises mean−λ·std at imagination time. TARGETED fix for the exp0054 over-optimism (penalises OOD disagreement, not all OOD → spares the true gesture, unlike exp0047's blanket push-down). BUILT + reviewer-SHIP + CPU-smoked; λ∈{0.5,1,2,5} sweep dispatching. Bar: swap_follow >0.10 + reward-gap shrunk (draft)
