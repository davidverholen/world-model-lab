...
our agent lacks entirely (2026-06-12):
...
## Language ≠ the subgoal gap; language ≠ a plugged-in LLM (2026-06-13)
...
The hard part: how to check the word is connected to the internal model, not
...
The cognitive analogy: humans convert text into mental imagery/simulation
...
**Unified trust-weighted replay (2026-06-12):** every transition carries a
...
## Horizon: self-generated hypotheses (2026-06-12)
...
## Word associations: an "association matrix" IS a word embedding (2026-06-13)

The intuition: humans have associations with words; the word itself "lands in latent space".
...
- **An association matrix IS a word embedding.** Distributional semantics: word2vec/
  ...
  2014). So don't rebuild it as metadata (the "doesn't scale" instinct is right —
...
## Ideas to look into later: symbols-as-thought, not pixels (2026-06-13)
