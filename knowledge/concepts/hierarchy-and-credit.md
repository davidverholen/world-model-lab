...
Constraint (subgoals needed only when the door blocks → must be discovered, latent, conditional):
...
## Where to test it — three-tier ladder (2026-06-13)
